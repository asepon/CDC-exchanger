...
/* package Exchanger-0.1.0.0 */
#ifndef VERSION_Exchanger
#define VERSION_Exchanger "0.1.0.0"
#endif /* VERSION_Exchanger */
#ifndef MIN_VERSION_Exchanger
#define MIN_VERSION_Exchanger(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Exchanger */
...
#define CURRENT_COMPONENT_ID "Exchanger-0.1.0.0-inplace-Exchanger"
